...
function user_register()
{
    jQuery('.field_error').html('');
        ...
        if(username=="")
        {
            jQuery('#name_error').html('Please enter proper name');  
            is_error='yes';
        }
        if(email=="")
        {
        ...
        if(adhar=="")
        {
            jQuery('#adharno_error').html('Please enter proper adhar number');  
            is_error='yes';
        }
        if(mobile=="")
        {
            jQuery('#mobile_error').html('Please enter proper mobile');  
            is_error='yes';
        }
        if(password=="")
        {
            jQuery('#password_error').html('Please enter proper password');  
            is_error='yes';
        }
        ...
        if(is_error=='')
        {
            jQuery.ajax({
    			...
    			type:'post',
    			data:'&username='+username+'&email='+email+'&adhar='+adhar+'&mobile='+mobile+'&password='+password,
    			success:function(result){
                    ...
                    if(result=='insert')
                    {
                        jQuery('.register_msg p').html('Succesfully register...'); 
                    }
      		                        }	
    		            });
        }
